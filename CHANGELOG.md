...
## Unreleased
- [FE] 🧭 **Prisma 관계 내보내기 정합화**: 실제 encoded source/target handle을 원래 컬럼명으로 역해석하고, 같은 source field를 공유하는 distinct relation을 보존하며, 이전 raw handle 형식도 계속 읽습니다. `nanoid` high advisory override도 lockfile에 반영했습니다.
