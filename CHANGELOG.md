...
## Unreleased
- [BE/Docs] **성능·용량 프로파일 1차 기준**: 구매자 데이터 없이 재현 가능한 small/medium/large 스키마 workload와 FK skew 변형, JSON/ Snowflake DDL benchmark manifest, Rust/GPU 전환 기준을 추가했습니다. 아직 production SLO나 SLA를 주장하지 않습니다.
