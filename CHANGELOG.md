...
## Unreleased
- [BE] 🔒 **DSN 오류 비밀정보 redaction 정합화**: authority와 form query의 디코딩 규칙을 분리하고, case-sensitive exact candidate와 Unicode short-secret boundary를 적용하며, malformed DSN·literal plus·국제화 식별자 회귀를 추가했습니다.
