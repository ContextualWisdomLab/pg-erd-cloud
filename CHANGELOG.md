...
## Unreleased
- [BE] 🔒 **JOSE `crit` fail-closed validation**: reject every present critical-header value, including explicit `null`, empty arrays, oversized arrays, malformed entries, and unsupported extensions before signature verification.
