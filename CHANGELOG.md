...
## [Unreleased]
### 보안
- MySQL 인트로스펙터 내 쿼리 구조 구성 시 오탐지되는 SQL 인젝션 보안 경고(Bandit B608) 수정.

## [Unreleased]
### 보안
- Python `ecdsa` 라이브러리의 P-256 Minerva 타이밍 공격 취약점(CVE-2024-23342, GHSA-wj6h-64fc-37mp) 해결을 위해 최소 버전을 `0.19.2`로 고정.
