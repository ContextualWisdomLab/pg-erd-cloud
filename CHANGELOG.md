...
## Unreleased
- [FE] ⚡ **Prisma 관계 export 선형화**: pre-index node columns and per-field relation arrays so canonical handles resolve to their original columns and multiple relations sharing one field are preserved in O(N*C + E).
