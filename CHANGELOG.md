...
## Unreleased
- [BE] 🔒 **Pydantic 입력 경계 강화**: 프로젝트·멤버·연결·주석·DBML·API 키 입력의 C0/C1 제어문자를 거부하고, forward SQL은 허용된 DDL subset 검증을 통과한 뒤에만 실행 계층으로 전달합니다. CodeQL backfill 브랜치 입력도 허용 문자 집합으로 제한합니다.
