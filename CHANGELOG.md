...
- [FE] ⚡ **ERD 핸들 ID 순회 비용 측정 정합화**: `for..of` 구현과 Unicode·빈 문자열 corpus를 50회 counterbalanced benchmark로 검증하고, 짝수 표본 median과 원본 표본 순서를 정확히 보존합니다. `heapUsed` delta는 allocation이 아닌 진단값으로 기록합니다.
