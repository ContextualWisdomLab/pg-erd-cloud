...
## [Unreleased]
### Added
- 모달의 필수 입력 항목을 시각적으로 표시하고 공백만 입력한 값의 저장을 막아 사용자에게 브라우저 검증 피드백을 제공합니다.
- 모달 닫기 심볼에 접근성 이름을 유지하고 시각 심볼을 보조기술에서 숨깁니다.
...
### Security
- `nanoid`를 `3.3.18` 이상으로 override하고 lockfile에 고정해 High 취약점(GHSA-2v37-7h3g-55p8)을 제거했습니다.
- `nanoid`를 `3.3.18` 이상으로 override하고 lockfile에 고정해 High 취약점(GHSA-2v37-7h3g-55p8)을 제거했습니다.
