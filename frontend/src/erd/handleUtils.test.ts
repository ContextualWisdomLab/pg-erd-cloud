...
describe('handleUtils', () => {
  ...
  describe('parseColumnNameFromHandle', () => {
    it('should decode a valid source handle', () => {
      expect(parseColumnNameFromHandle('src-c-0069-0064')).toBe('id');
    });

    it('should decode a valid target handle', () => {
      expect(parseColumnNameFromHandle('tgt-c-0069-0064')).toBe('id');
    });

    it('should decode a valid handle with unicode characters', () => {
    ...
    it('should return null for invalid handle prefix', () => {
      expect(parseColumnNameFromHandle('invalid-c-0069')).toBeNull();
    });

    it('should return null for invalid hex codes', () => {
      expect(parseColumnNameFromHandle('src-c-invalid')).toBeNull();
    });

    it('should return null for missing or null handle', () => {
