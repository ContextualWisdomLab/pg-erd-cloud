...
export function exportDDL(nodes: Node<TableNodeData>[], edges: Edge[]): string {
  ...
  // ⚡ Bolt: Use for-of to prevent intermediate array allocations during Map creation
...
export function exportDiagramSvg(
  ...
  // ⚡ Bolt: Prevent array mapping and spreading overhead while computing node bounds
