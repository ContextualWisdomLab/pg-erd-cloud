...
describe('snapshotToGraph', () => {
  ...
  it('falls back to constraints if fk_edges is empty or not provided', () => {
    const snapshot: SnapshotInput = {
      ...
      columns: [],
      constraints: [
        { constraint_type: 'p', relation_oid: 1, constraint_oid: 99 },
        { constraint_type: 'f', relation_oid: 2, foreign_relation_oid: 1, constraint_oid: 100, constraint_name: 'fk_user_old' }
      ]
    }
