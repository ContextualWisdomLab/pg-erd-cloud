...
export default function App() {
  ...
  const searchMatchedNodeIds = useMemo(() => {
    ...
    for (const node of nodes) {
      // ⚡ Bolt: Build search haystack using string concatenation instead of array allocations
      // (.flatMap, spread syntax, .join) to significantly reduce GC overhead during frequent React hook executions.
