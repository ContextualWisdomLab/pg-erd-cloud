...
export default function App() {
  ...
  async function onCreateConnectionSubmit(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
    if (!selectedProjectId || isCreatingConnection) return;
    const formData = new FormData(e.currentTarget);
    const nextConnectionName = (formData.get("connName") as string)?.trim() ?? "";
    const connectionDsn = (formData.get("dsn") as string)?.trim() ?? "";
    ...
    try {
      ...
      const dsnInput = e.currentTarget.elements.namedItem("dsn") as HTMLInputElement;
  ...
  return (
    <div className="layout">
      ...
      <aside className="sidebar">
        ...
        <form className="field" onSubmit={onCreateConnectionSubmit} autoComplete="off">
