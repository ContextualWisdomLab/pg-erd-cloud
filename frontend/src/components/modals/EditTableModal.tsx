        ...
        <div className="row" style={{ justifyContent: "space-between", marginTop: 16, paddingTop: 16, borderTop: "1px solid #e2e8f0" }}>
          <div className="row" style={{ gap: 8 }}>
            <button
              ...
              aria-label={`${editingNode.data.schema ? `${editingNode.data.schema}.` : ''}${editingNode.data.title} 테이블 삭제`}
            ...
            <button
              type="button"
              aria-label={`${editingNode.data.schema ? `${editingNode.data.schema}.` : ''}${editingNode.data.title} 테이블 복제`}
              onClick={() => {
