...
describe('modal behavior coverage', () => {
  ...
  it('covers EditEdgeModal visibility and actions', () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: 'a에서 b 관계 삭제' }))
    fireEvent.click(screen.getByRole('button', { name: 'a에서 b 관계 취소' }))
    fireEvent.click(screen.getByRole('button', { name: 'a에서 b 관계 저장' }))
