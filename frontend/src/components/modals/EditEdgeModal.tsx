      ...
      >
        ...
        >
          <button
            ...
            aria-label={`${editingEdge.source}에서 ${editingEdge.target} 관계 삭제`}
          >
            삭제
          </button>
          <div className="row">
            <button type="button" onClick={onRelCancel} aria-label={`${editingEdge.source}에서 ${editingEdge.target} 관계 취소`}>취소</button>
            <button
              type="submit"
              style={{ background: "#034ea2", color: "#fff" }}
              aria-label={`${editingEdge.source}에서 ${editingEdge.target} 관계 저장`}
            >
              저장
            </button>
          </div>
