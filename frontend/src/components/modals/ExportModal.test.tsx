...
describe('ExportModal', () => {
  ...
  it('exposes access-control guidance for disabled button', async () => {
    ...
    // Check aria-disabled state instead of native disabled
    ...
    // Verify it blocks interaction via Enter key
    await user.keyboard('{Enter}');
    // Check window location or form submission hasn't happened - testing preventDefault
    // simply by confirming no crash or change, though user-event triggers it gracefully.
  });
});
