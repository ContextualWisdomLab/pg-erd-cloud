...
def _snapshot_json_to_postgresql_sql(snapshot: dict) -> str:
    ...
    _generate_tables_pg(tables, cols_by_oid, constraints_by_oid, source_dialect, lines)
...
def _generate_tables_snowflake(
    tables: list[dict],
    cols_by_oid: dict[int, list[dict]],
    constraints_by_oid: dict[int, list[dict]],
    source_dialect: DdlDialect,
...
def _snapshot_json_to_snowflake_sql(snapshot: dict) -> str:
    ...
    _generate_tables_snowflake(
        tables, cols_by_oid, constraints_by_oid, source_dialect, lines
    )
