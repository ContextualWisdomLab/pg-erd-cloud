...
**Action:** Replace repeated linear array scans for edges by precomputing an O(1) Map of handle IDs to column names for all nodes before entering the edge loop.
