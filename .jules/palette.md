...
**Action:** Update the tests to use regex matching (e.g., `getByLabelText(/Label Name/)`) to prevent test suite failures, and ensure the exact styling matches the existing codebase using proper class names.
